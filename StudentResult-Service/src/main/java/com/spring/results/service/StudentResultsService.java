...
public class StudentResultsService {
    ...
    static {
        ...
        marksMap.put(2, new Marks(55, 34, 78, 60, 74));
        marksMap.put(3, new Marks(89, 45, 74, 86, 92, 76));
        marksMap.put(4, new Marks(64, 65, 89, 55, 67, 89));
        marksMap.put(5, new Marks(29, 47, 53, 37));
        marksMap.put(6, new Marks(81, 56, 78, 62, 74, 91));
        marksMap.put(7, new Marks(72, 91, 86, 83, 79));
        marksMap.put(8, new Marks(87, 73, 91, 59, 63, 78));
        marksMap.put(9, new Marks(95, 92, 96, 91, 96));
        marksMap.put(10, new Marks(86, 84, 98, 88));
    }
